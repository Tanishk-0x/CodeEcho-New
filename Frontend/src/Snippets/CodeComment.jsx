  ...
  const fetchData = async () => {
    ...
    try {
      ...
      You are a code comment generator.
        ...
        3. ${level} = onTop
        Add brief but clear summary comments at the top of the entire code, also any other line should not contain any comments move all the comments to the top describing what the code does.
